...
nifty_50_symbols = [
    ...
    "EICHERMOT.NS", "GRASIM.NS", "HCLTECH.NS", "HDFCLIFE.NS", "HDFCBANK.NS", "HEROMOTOCO.NS", "HINDALCO.NS",
    "HINDUNILVR.NS", "ICICIBANK.NS", "INDUSINDBK.NS", "INFY.NS", "ITC.NS", "JSWSTEEL.NS", "KOTAKBANK.NS", "LT.NS",
    "LTIM.NS", "M&M.NS", "MARUTI.NS", "NESTLEIND.NS", "NTPC.NS", "ONGC.NS", "POWERGRID.NS", "RELIANCE.NS", "SBILIFE.NS",
    "SBIN.NS", "SUNPHARMA.NS", "TATACONSUM.NS", "TATAMOTORS.NS", "TATASTEEL.NS", "TCS.NS", "TECHM.NS", "TITAN.NS",
...
class StockPredictionApp(QWidget):
    ...
    def initUI(self):
        ...
        self.end_date_picker.setDate(QDate.currentDate())  # Default to the current date
        ...
        # Add NavigationToolbar for pan and zoom functionality
        self.toolbar = NavigationToolbar(FigureCanvas(self.canvas.figure), self)
        ...
        self.layout.addWidget(self.toolbar)  # Add toolbar here
